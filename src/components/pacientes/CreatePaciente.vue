    ...
    <div class="container" style="background-color: #808080;">
      ...
      <form @submit.prevent="guardarPaciente">
        <div class="form-group">
          ...
          <input type="text" v-model="paciente.id" class="form-control" id="id" required>
        </div>
        <div class="form-group">
...
export default {
  ...
  methods: {
    ...
    async guardarPaciente() {
      try {
        console.log(this.paciente.id+' '+this.paciente.nombre+' '+this.paciente.apellido+' '+this.paciente.fecha_nacimiento+' '+this.paciente.sexo+' '+this.paciente.direccion+' '+this.paciente.telefono+' '+this.paciente.email)
